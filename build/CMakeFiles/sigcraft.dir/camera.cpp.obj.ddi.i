# 0 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
# 1 "C:/msys64/mingw64/include/c++/15.2.0/cassert" 1 3
# 45 "C:/msys64/mingw64/include/c++/15.2.0/cassert" 3
...
# 46 "C:/msys64/mingw64/include/c++/15.2.0/cassert" 2 3
...
# 36 "C:/msys64/mingw64/include/c++/15.2.0/stdlib.h" 3
...
# 37 "C:/msys64/mingw64/include/c++/15.2.0/stdlib.h" 2 3
...
# 2 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 2

# 1 "C:/Users/darkg/HAG/sigcraft/camera.h" 1
...
# 4 "C:/Users/darkg/HAG/sigcraft/camera.h" 2
# 1 "C:/msys64/mingw64/include/c++/15.2.0/math.h" 1 3
# 36 "C:/msys64/mingw64/include/c++/15.2.0/math.h" 3
...
# 43 "C:/msys64/mingw64/include/c++/15.2.0/bits/cpp_type_traits.h" 2 3
...
#pragma GCC diagnostic pop
# 50 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 2 3
...
#pragma GCC diagnostic pop
# 51 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 2 3
...
# 1060 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 3
  template<typename _Tp, typename _Up>
    inline constexpr
...
# 3689 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 3
  template<typename _Tp, typename _Up>
...
# 3838 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 3
...
# 3909 "C:/msys64/mingw64/include/c++/15.2.0/cmath" 3
...
# 44 "C:/msys64/mingw64/include/c++/15.2.0/bits/specfun.h" 2 3
...
# 37 "C:/msys64/mingw64/include/c++/15.2.0/math.h" 2 3
...
using std::lerp;
# 5 "C:/Users/darkg/HAG/sigcraft/camera.h" 2

# 1 "C:/Users/darkg/HAG/shady/include/nasl/nasl.h" 1 3 4
# 19 "C:/Users/darkg/HAG/shady/include/nasl/nasl.h" 3 4
# 1 "C:/Users/darkg/HAG/shady/include/nasl/nasl_vec.h" 1 3 4




namespace nasl {
# 22 "C:/Users/darkg/HAG/shady/include/nasl/nasl_vec.h" 3 4
...
# 48 "C:/Users/darkg/HAG/shady/include/nasl/nasl_vec.h" 3 4
static_assert(202002L >= 202002L, "C++20 is required. If you are using MSVC you need to enable /Zc:__cplusplus");
...
constexpr inline static bool fits(unsigned len, const int* mapping) {
...
struct vec_impl {
    ...
    constexpr inline vec_impl() = default;
    constexpr inline vec_impl(T s) {
        for_range<0, len>([&]<auto i>(){
            arr[i] = s;
        });
    }

    constexpr inline vec_impl(T x, T y, T z, T w) requires (len >= 4) {
        this->arr[0] = x;
        this->arr[1] = y;
        this->arr[2] = z;
        this->arr[3] = w;
    ...
    constexpr inline vec_impl(vec_impl<T, 2> xy, T z, T w) requires (len >= 4) : vec_impl(xy.x, xy.y, z, w) {}
    constexpr inline vec_impl(T x, vec_impl<T, 2> yz, T w) requires (len >= 4) : vec_impl(x, yz.x, yz.y, w) {}
    constexpr inline vec_impl(T x, T y, vec_impl<T, 2> zw) requires (len >= 4) : vec_impl(x, y, zw.x, zw.y) {}
    constexpr inline vec_impl(vec_impl<T, 2> xy, vec_impl<T, 2> zw) requires (len >= 4) : vec_impl(xy.x, xy.y, zw.x, zw.y) {}

    constexpr inline vec_impl(vec_impl<T, 3> xyz, T w) requires (len >= 4) : vec_impl(xyz.x, xyz.y, xyz.z, w) {}
    constexpr inline vec_impl(T x, vec_impl<T, 3> yzw) requires (len >= 4) : vec_impl(x, yzw.x, yzw.y, yzw.z) {}

    constexpr inline vec_impl(T x, T y, T z) requires (len >= 3) {
        this->arr[0] = x;
        this->arr[1] = y;
        this->arr[2] = z;
    }

    constexpr inline vec_impl(vec_impl<T, 2> xy, T z) requires (len >= 3) : vec_impl(xy.x, xy.y, z) {}
    constexpr inline vec_impl(T x, vec_impl<T, 2> yz) requires (len >= 3) : vec_impl(x, yz.x, yz.y) {}

    constexpr inline vec_impl(T x, T y) {
        this->arr[0] = x;
        this->arr[1] = y;
    }


    constexpr inline vec_impl(Native n) {
        for_range<0, len>([&]<auto i>(){
            arr[i] = n[i];
        });
    }

    constexpr inline operator Native() const {
        Native n;
        for_range<0, len>([&]<auto i>(){
            n[i] = arr[i];
        });
    ...
    constexpr inline This operator +(This other) const {
        This result;
        for_range<0, len>([&]<auto i>(){
    ...
    constexpr inline This operator *(T s) const {
        This result;
        for_range<0, len>([&]<auto i>(){
    ...
    constexpr inline This cross(const This &other) const requires(len == 3) {
        return { this->y * other.z - this->z * other.y,
                 this->z * other.x - this->x * other.z,
                 this->x * other.y - this->y * other.x };
    }

    constexpr inline T dot(const This& other) const {
        T acc = 0;
        for_range<0, len>([&]<auto i>(){
    ...
    struct Swizzler {
        static constexpr int _indices[] = {indices...};
        static constexpr int dst_len = sizeof(_indices) / sizeof(int);
        using That = vec_impl<T, dst_len>;

        constexpr inline operator That() const requires(dst_len > 1 && fits<dst_len>(len, _indices)) {
            auto src = reinterpret_cast<const This*>(this);
            That dst;
            for_range<0, dst_len>([&]<auto i>(){
                dst.arr[i] = src->arr[_indices[i]];
            });
            return dst;
        }
        ...
        constexpr inline operator ThatNative() const requires(dst_len > 1 && fits<dst_len>(len, _indices)) {
            That that = *this;
            return that;
        }


        constexpr inline operator T() const requires(dst_len == 1 && fits<dst_len>(len, _indices)) {
            auto src = reinterpret_cast<const This*>(this);
            return src->arr[_indices[0]];
        }

        constexpr inline void operator=(const T& t) requires(dst_len == 1 && fits<dst_len>(len, _indices)) {
            auto src = reinterpret_cast<This*>(this);
            src->arr[_indices[0]] = t;
        }

        constexpr inline void operator=(const That& src) requires(dst_len > 1 && fits<dst_len>(len, _indices)) {
            auto dst = reinterpret_cast<This*>(this);
            for_range<0, dst_len>([&]<auto i>(){
                dst->arr[_indices[i]] = src.arr[i];
            });
        }
    };
# 286 "C:/Users/darkg/HAG/shady/include/nasl/nasl_vec.h" 3 4
    union {
        Swizzler<0> x; Swizzler<1> y; Swizzler<2> z; Swizzler<3> w;
        Swizzler<0, 0> xx; Swizzler<0, 1> xy; Swizzler<0, 2> xz; Swizzler<0, 3> xw; Swizzler<1, 0> yx; Swizzler<1, 1> yy; Swizzler<1, 2> yz; Swizzler<1, 3> yw; Swizzler<2, 0> zx; Swizzler<2, 1> zy; Swizzler<2, 2> zz; Swizzler<2, 3> zw; Swizzler<3, 0> wx; Swizzler<3, 1> wy; Swizzler<3, 2> wz; Swizzler<3, 3> ww;
        Swizzler<0, 0, 0> xxx; Swizzler<0, 0, 1> xxy; Swizzler<0, 0, 2> xxz; Swizzler<0, 0, 3> xxw; Swizzler<0, 1, 0> xyx; Swizzler<0, 1, 1> xyy; Swizzler<0, 1, 2> xyz; Swizzler<0, 1, 3> xyw; Swizzler<0, 2, 0> xzx; Swizzler<0, 2, 1> xzy; Swizzler<0, 2, 2> xzz; Swizzler<0, 2, 3> xzw; Swizzler<0, 3, 0> xwx; Swizzler<0, 3, 1> xwy; Swizzler<0, 3, 2> xwz; Swizzler<0, 3, 3> xww; Swizzler<1, 0, 0> yxx; Swizzler<1, 0, 1> yxy; Swizzler<1, 0, 2> yxz; Swizzler<1, 0, 3> yxw; Swizzler<1, 1, 0> yyx; Swizzler<1, 1, 1> yyy; Swizzler<1, 1, 2> yyz; Swizzler<1, 1, 3> yyw; Swizzler<1, 2, 0> yzx; Swizzler<1, 2, 1> yzy; Swizzler<1, 2, 2> yzz; Swizzler<1, 2, 3> yzw; Swizzler<1, 3, 0> ywx; Swizzler<1, 3, 1> ywy; Swizzler<1, 3, 2> ywz; Swizzler<1, 3, 3> yww; Swizzler<2, 0, 0> zxx; Swizzler<2, 0, 1> zxy; Swizzler<2, 0, 2> zxz; Swizzler<2, 0, 3> zxw; Swizzler<2, 1, 0> zyx; Swizzler<2, 1, 1> zyy; Swizzler<2, 1, 2> zyz; Swizzler<2, 1, 3> zyw; Swizzler<2, 2, 0> zzx; Swizzler<2, 2, 1> zzy; Swizzler<2, 2, 2> zzz; Swizzler<2, 2, 3> zzw; Swizzler<2, 3, 0> zwx; Swizzler<2, 3, 1> zwy; Swizzler<2, 3, 2> zwz; Swizzler<2, 3, 3> zww; Swizzler<3, 0, 0> wxx; Swizzler<3, 0, 1> wxy; Swizzler<3, 0, 2> wxz; Swizzler<3, 0, 3> wxw; Swizzler<3, 1, 0> wyx; Swizzler<3, 1, 1> wyy; Swizzler<3, 1, 2> wyz; Swizzler<3, 1, 3> wyw; Swizzler<3, 2, 0> wzx; Swizzler<3, 2, 1> wzy; Swizzler<3, 2, 2> wzz; Swizzler<3, 2, 3> wzw; Swizzler<3, 3, 0> wwx; Swizzler<3, 3, 1> wwy; Swizzler<3, 3, 2> wwz; Swizzler<3, 3, 3> www;
        Swizzler<0, 0, 0, 0> xxxx; Swizzler<0, 0, 0, 1> xxxy; Swizzler<0, 0, 0, 2> xxxz; Swizzler<0, 0, 0, 3> xxxw; Swizzler<0, 0, 1, 0> xxyx; Swizzler<0, 0, 1, 1> xxyy; Swizzler<0, 0, 1, 2> xxyz; Swizzler<0, 0, 1, 3> xxyw; Swizzler<0, 0, 2, 0> xxzx; Swizzler<0, 0, 2, 1> xxzy; Swizzler<0, 0, 2, 2> xxzz; Swizzler<0, 0, 2, 3> xxzw; Swizzler<0, 0, 3, 0> xxwx; Swizzler<0, 0, 3, 1> xxwy; Swizzler<0, 0, 3, 2> xxwz; Swizzler<0, 0, 3, 3> xxww; Swizzler<0, 1, 0, 0> xyxx; Swizzler<0, 1, 0, 1> xyxy; Swizzler<0, 1, 0, 2> xyxz; Swizzler<0, 1, 0, 3> xyxw; Swizzler<0, 1, 1, 0> xyyx; Swizzler<0, 1, 1, 1> xyyy; Swizzler<0, 1, 1, 2> xyyz; Swizzler<0, 1, 1, 3> xyyw; Swizzler<0, 1, 2, 0> xyzx; Swizzler<0, 1, 2, 1> xyzy; Swizzler<0, 1, 2, 2> xyzz; Swizzler<0, 1, 2, 3> xyzw; Swizzler<0, 1, 3, 0> xywx; Swizzler<0, 1, 3, 1> xywy; Swizzler<0, 1, 3, 2> xywz; Swizzler<0, 1, 3, 3> xyww; Swizzler<0, 2, 0, 0> xzxx; Swizzler<0, 2, 0, 1> xzxy; Swizzler<0, 2, 0, 2> xzxz; Swizzler<0, 2, 0, 3> xzxw; Swizzler<0, 2, 1, 0> xzyx; Swizzler<0, 2, 1, 1> xzyy; Swizzler<0, 2, 1, 2> xzyz; Swizzler<0, 2, 1, 3> xzyw; Swizzler<0, 2, 2, 0> xzzx; Swizzler<0, 2, 2, 1> xzzy; Swizzler<0, 2, 2, 2> xzzz; Swizzler<0, 2, 2, 3> xzzw; Swizzler<0, 2, 3, 0> xzwx; Swizzler<0, 2, 3, 1> xzwy; Swizzler<0, 2, 3, 2> xzwz; Swizzler<0, 2, 3, 3> xzww; Swizzler<0, 3, 0, 0> xwxx; Swizzler<0, 3, 0, 1> xwxy; Swizzler<0, 3, 0, 2> xwxz; Swizzler<0, 3, 0, 3> xwxw; Swizzler<0, 3, 1, 0> xwyx; Swizzler<0, 3, 1, 1> xwyy; Swizzler<0, 3, 1, 2> xwyz; Swizzler<0, 3, 1, 3> xwyw; Swizzler<0, 3, 2, 0> xwzx; Swizzler<0, 3, 2, 1> xwzy; Swizzler<0, 3, 2, 2> xwzz; Swizzler<0, 3, 2, 3> xwzw; Swizzler<0, 3, 3, 0> xwwx; Swizzler<0, 3, 3, 1> xwwy; Swizzler<0, 3, 3, 2> xwwz; Swizzler<0, 3, 3, 3> xwww; Swizzler<1, 0, 0, 0> yxxx; Swizzler<1, 0, 0, 1> yxxy; Swizzler<1, 0, 0, 2> yxxz; Swizzler<1, 0, 0, 3> yxxw; Swizzler<1, 0, 1, 0> yxyx; Swizzler<1, 0, 1, 1> yxyy; Swizzler<1, 0, 1, 2> yxyz; Swizzler<1, 0, 1, 3> yxyw; Swizzler<1, 0, 2, 0> yxzx; Swizzler<1, 0, 2, 1> yxzy; Swizzler<1, 0, 2, 2> yxzz; Swizzler<1, 0, 2, 3> yxzw; Swizzler<1, 0, 3, 0> yxwx; Swizzler<1, 0, 3, 1> yxwy; Swizzler<1, 0, 3, 2> yxwz; Swizzler<1, 0, 3, 3> yxww; Swizzler<1, 1, 0, 0> yyxx; Swizzler<1, 1, 0, 1> yyxy; Swizzler<1, 1, 0, 2> yyxz; Swizzler<1, 1, 0, 3> yyxw; Swizzler<1, 1, 1, 0> yyyx; Swizzler<1, 1, 1, 1> yyyy; Swizzler<1, 1, 1, 2> yyyz; Swizzler<1, 1, 1, 3> yyyw; Swizzler<1, 1, 2, 0> yyzx; Swizzler<1, 1, 2, 1> yyzy; Swizzler<1, 1, 2, 2> yyzz; Swizzler<1, 1, 2, 3> yyzw; Swizzler<1, 1, 3, 0> yywx; Swizzler<1, 1, 3, 1> yywy; Swizzler<1, 1, 3, 2> yywz; Swizzler<1, 1, 3, 3> yyww; Swizzler<1, 2, 0, 0> yzxx; Swizzler<1, 2, 0, 1> yzxy; Swizzler<1, 2, 0, 2> yzxz; Swizzler<1, 2, 0, 3> yzxw; Swizzler<1, 2, 1, 0> yzyx; Swizzler<1, 2, 1, 1> yzyy; Swizzler<1, 2, 1, 2> yzyz; Swizzler<1, 2, 1, 3> yzyw; Swizzler<1, 2, 2, 0> yzzx; Swizzler<1, 2, 2, 1> yzzy; Swizzler<1, 2, 2, 2> yzzz; Swizzler<1, 2, 2, 3> yzzw; Swizzler<1, 2, 3, 0> yzwx; Swizzler<1, 2, 3, 1> yzwy; Swizzler<1, 2, 3, 2> yzwz; Swizzler<1, 2, 3, 3> yzww; Swizzler<1, 3, 0, 0> ywxx; Swizzler<1, 3, 0, 1> ywxy; Swizzler<1, 3, 0, 2> ywxz; Swizzler<1, 3, 0, 3> ywxw; Swizzler<1, 3, 1, 0> ywyx; Swizzler<1, 3, 1, 1> ywyy; Swizzler<1, 3, 1, 2> ywyz; Swizzler<1, 3, 1, 3> ywyw; Swizzler<1, 3, 2, 0> ywzx; Swizzler<1, 3, 2, 1> ywzy; Swizzler<1, 3, 2, 2> ywzz; Swizzler<1, 3, 2, 3> ywzw; Swizzler<1, 3, 3, 0> ywwx; Swizzler<1, 3, 3, 1> ywwy; Swizzler<1, 3, 3, 2> ywwz; Swizzler<1, 3, 3, 3> ywww; Swizzler<2, 0, 0, 0> zxxx; Swizzler<2, 0, 0, 1> zxxy; Swizzler<2, 0, 0, 2> zxxz; Swizzler<2, 0, 0, 3> zxxw; Swizzler<2, 0, 1, 0> zxyx; Swizzler<2, 0, 1, 1> zxyy; Swizzler<2, 0, 1, 2> zxyz; Swizzler<2, 0, 1, 3> zxyw; Swizzler<2, 0, 2, 0> zxzx; Swizzler<2, 0, 2, 1> zxzy; Swizzler<2, 0, 2, 2> zxzz; Swizzler<2, 0, 2, 3> zxzw; Swizzler<2, 0, 3, 0> zxwx; Swizzler<2, 0, 3, 1> zxwy; Swizzler<2, 0, 3, 2> zxwz; Swizzler<2, 0, 3, 3> zxww; Swizzler<2, 1, 0, 0> zyxx; Swizzler<2, 1, 0, 1> zyxy; Swizzler<2, 1, 0, 2> zyxz; Swizzler<2, 1, 0, 3> zyxw; Swizzler<2, 1, 1, 0> zyyx; Swizzler<2, 1, 1, 1> zyyy; Swizzler<2, 1, 1, 2> zyyz; Swizzler<2, 1, 1, 3> zyyw; Swizzler<2, 1, 2, 0> zyzx; Swizzler<2, 1, 2, 1> zyzy; Swizzler<2, 1, 2, 2> zyzz; Swizzler<2, 1, 2, 3> zyzw; Swizzler<2, 1, 3, 0> zywx; Swizzler<2, 1, 3, 1> zywy; Swizzler<2, 1, 3, 2> zywz; Swizzler<2, 1, 3, 3> zyww; Swizzler<2, 2, 0, 0> zzxx; Swizzler<2, 2, 0, 1> zzxy; Swizzler<2, 2, 0, 2> zzxz; Swizzler<2, 2, 0, 3> zzxw; Swizzler<2, 2, 1, 0> zzyx; Swizzler<2, 2, 1, 1> zzyy; Swizzler<2, 2, 1, 2> zzyz; Swizzler<2, 2, 1, 3> zzyw; Swizzler<2, 2, 2, 0> zzzx; Swizzler<2, 2, 2, 1> zzzy; Swizzler<2, 2, 2, 2> zzzz; Swizzler<2, 2, 2, 3> zzzw; Swizzler<2, 2, 3, 0> zzwx; Swizzler<2, 2, 3, 1> zzwy; Swizzler<2, 2, 3, 2> zzwz; Swizzler<2, 2, 3, 3> zzww; Swizzler<2, 3, 0, 0> zwxx; Swizzler<2, 3, 0, 1> zwxy; Swizzler<2, 3, 0, 2> zwxz; Swizzler<2, 3, 0, 3> zwxw; Swizzler<2, 3, 1, 0> zwyx; Swizzler<2, 3, 1, 1> zwyy; Swizzler<2, 3, 1, 2> zwyz; Swizzler<2, 3, 1, 3> zwyw; Swizzler<2, 3, 2, 0> zwzx; Swizzler<2, 3, 2, 1> zwzy; Swizzler<2, 3, 2, 2> zwzz; Swizzler<2, 3, 2, 3> zwzw; Swizzler<2, 3, 3, 0> zwwx; Swizzler<2, 3, 3, 1> zwwy; Swizzler<2, 3, 3, 2> zwwz; Swizzler<2, 3, 3, 3> zwww; Swizzler<3, 0, 0, 0> wxxx; Swizzler<3, 0, 0, 1> wxxy; Swizzler<3, 0, 0, 2> wxxz; Swizzler<3, 0, 0, 3> wxxw; Swizzler<3, 0, 1, 0> wxyx; Swizzler<3, 0, 1, 1> wxyy; Swizzler<3, 0, 1, 2> wxyz; Swizzler<3, 0, 1, 3> wxyw; Swizzler<3, 0, 2, 0> wxzx; Swizzler<3, 0, 2, 1> wxzy; Swizzler<3, 0, 2, 2> wxzz; Swizzler<3, 0, 2, 3> wxzw; Swizzler<3, 0, 3, 0> wxwx; Swizzler<3, 0, 3, 1> wxwy; Swizzler<3, 0, 3, 2> wxwz; Swizzler<3, 0, 3, 3> wxww; Swizzler<3, 1, 0, 0> wyxx; Swizzler<3, 1, 0, 1> wyxy; Swizzler<3, 1, 0, 2> wyxz; Swizzler<3, 1, 0, 3> wyxw; Swizzler<3, 1, 1, 0> wyyx; Swizzler<3, 1, 1, 1> wyyy; Swizzler<3, 1, 1, 2> wyyz; Swizzler<3, 1, 1, 3> wyyw; Swizzler<3, 1, 2, 0> wyzx; Swizzler<3, 1, 2, 1> wyzy; Swizzler<3, 1, 2, 2> wyzz; Swizzler<3, 1, 2, 3> wyzw; Swizzler<3, 1, 3, 0> wywx; Swizzler<3, 1, 3, 1> wywy; Swizzler<3, 1, 3, 2> wywz; Swizzler<3, 1, 3, 3> wyww; Swizzler<3, 2, 0, 0> wzxx; Swizzler<3, 2, 0, 1> wzxy; Swizzler<3, 2, 0, 2> wzxz; Swizzler<3, 2, 0, 3> wzxw; Swizzler<3, 2, 1, 0> wzyx; Swizzler<3, 2, 1, 1> wzyy; Swizzler<3, 2, 1, 2> wzyz; Swizzler<3, 2, 1, 3> wzyw; Swizzler<3, 2, 2, 0> wzzx; Swizzler<3, 2, 2, 1> wzzy; Swizzler<3, 2, 2, 2> wzzz; Swizzler<3, 2, 2, 3> wzzw; Swizzler<3, 2, 3, 0> wzwx; Swizzler<3, 2, 3, 1> wzwy; Swizzler<3, 2, 3, 2> wzwz; Swizzler<3, 2, 3, 3> wzww; Swizzler<3, 3, 0, 0> wwxx; Swizzler<3, 3, 0, 1> wwxy; Swizzler<3, 3, 0, 2> wwxz; Swizzler<3, 3, 0, 3> wwxw; Swizzler<3, 3, 1, 0> wwyx; Swizzler<3, 3, 1, 1> wwyy; Swizzler<3, 3, 1, 2> wwyz; Swizzler<3, 3, 1, 3> wwyw; Swizzler<3, 3, 2, 0> wwzx; Swizzler<3, 3, 2, 1> wwzy; Swizzler<3, 3, 2, 2> wwzz; Swizzler<3, 3, 2, 3> wwzw; Swizzler<3, 3, 3, 0> wwwx; Swizzler<3, 3, 3, 1> wwwy; Swizzler<3, 3, 3, 2> wwwz; Swizzler<3, 3, 3, 3> wwww;
        T arr[len];
    };
...
# 400 "C:/Users/darkg/HAG/shady/include/nasl/nasl_vec.h" 3 4
static inline vec2 vec2_add(vec2 a, vec2 b) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline vec2 vec2_sub(vec2 a, vec2 b) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline vec2 vec2_mul(vec2 a, vec2 b) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline vec2 vec2_div(vec2 a, vec2 b) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline vec2 vec2_neg(vec2 a) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline vec2 vec2_scale(vec2 a, float scale) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline vec2 vec2_ctor(float f) { vec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = f; return thing; }
static inline vec3 vec3_add(vec3 a, vec3 b) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline vec3 vec3_sub(vec3 a, vec3 b) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline vec3 vec3_mul(vec3 a, vec3 b) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline vec3 vec3_div(vec3 a, vec3 b) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline vec3 vec3_neg(vec3 a) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline vec3 vec3_scale(vec3 a, float scale) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline vec3 vec3_ctor(float f) { vec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = f; return thing; }
static inline vec4 vec4_add(vec4 a, vec4 b) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline vec4 vec4_sub(vec4 a, vec4 b) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline vec4 vec4_mul(vec4 a, vec4 b) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline vec4 vec4_div(vec4 a, vec4 b) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline vec4 vec4_neg(vec4 a) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline vec4 vec4_scale(vec4 a, float scale) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline vec4 vec4_ctor(float f) { vec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = f; return thing; }
static inline ivec2 ivec2_add(ivec2 a, ivec2 b) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline ivec2 ivec2_sub(ivec2 a, ivec2 b) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline ivec2 ivec2_mul(ivec2 a, ivec2 b) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline ivec2 ivec2_div(ivec2 a, ivec2 b) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline ivec2 ivec2_neg(ivec2 a) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline ivec2 ivec2_scale(ivec2 a, int scale) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline ivec2 ivec2_ctor(int f) { ivec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = f; return thing; }
static inline ivec3 ivec3_add(ivec3 a, ivec3 b) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline ivec3 ivec3_sub(ivec3 a, ivec3 b) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline ivec3 ivec3_mul(ivec3 a, ivec3 b) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline ivec3 ivec3_div(ivec3 a, ivec3 b) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline ivec3 ivec3_neg(ivec3 a) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline ivec3 ivec3_scale(ivec3 a, int scale) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline ivec3 ivec3_ctor(int f) { ivec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = f; return thing; }
static inline ivec4 ivec4_add(ivec4 a, ivec4 b) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline ivec4 ivec4_sub(ivec4 a, ivec4 b) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline ivec4 ivec4_mul(ivec4 a, ivec4 b) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline ivec4 ivec4_div(ivec4 a, ivec4 b) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline ivec4 ivec4_neg(ivec4 a) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline ivec4 ivec4_scale(ivec4 a, int scale) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline ivec4 ivec4_ctor(int f) { ivec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = f; return thing; }
static inline uvec2 uvec2_add(uvec2 a, uvec2 b) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline uvec2 uvec2_sub(uvec2 a, uvec2 b) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline uvec2 uvec2_mul(uvec2 a, uvec2 b) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline uvec2 uvec2_div(uvec2 a, uvec2 b) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline uvec2 uvec2_neg(uvec2 a) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline uvec2 uvec2_scale(uvec2 a, unsigned scale) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline uvec2 uvec2_ctor(unsigned f) { uvec2 thing; for (int i = 0; i < 2; i++) thing.arr[i] = f; return thing; }
static inline uvec3 uvec3_add(uvec3 a, uvec3 b) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline uvec3 uvec3_sub(uvec3 a, uvec3 b) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline uvec3 uvec3_mul(uvec3 a, uvec3 b) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline uvec3 uvec3_div(uvec3 a, uvec3 b) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline uvec3 uvec3_neg(uvec3 a) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline uvec3 uvec3_scale(uvec3 a, unsigned scale) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline uvec3 uvec3_ctor(unsigned f) { uvec3 thing; for (int i = 0; i < 3; i++) thing.arr[i] = f; return thing; }
static inline uvec4 uvec4_add(uvec4 a, uvec4 b) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) + (b.arr[i])); return thing; } static inline uvec4 uvec4_sub(uvec4 a, uvec4 b) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) - (b.arr[i])); return thing; } static inline uvec4 uvec4_mul(uvec4 a, uvec4 b) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * (b.arr[i])); return thing; } static inline uvec4 uvec4_div(uvec4 a, uvec4 b) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) / (b.arr[i])); return thing; } static inline uvec4 uvec4_neg(uvec4 a) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = (-(a.arr[i])); return thing; } static inline uvec4 uvec4_scale(uvec4 a, unsigned scale) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = ((a.arr[i]) * scale); return thing; } static inline uvec4 uvec4_ctor(unsigned f) { uvec4 thing; for (int i = 0; i < 4; i++) thing.arr[i] = f; return thing; }


template<unsigned len>
static inline float lengthSquared(vec_impl<float, len> vec) {
    float acc = 0.0f;
    for_range<0, len>([&]<auto i>(){
...
template<unsigned len>
static inline float length(vec_impl<float, len> vec) {
    return sqrtf(lengthSquared(vec));
}

template<unsigned len>
static inline vec_impl<float, len> normalize(vec_impl<float, len> vec) {
    return vec / length(vec);
}

template<typename T, unsigned len>
constexpr inline vec_impl<T, len> operator *(T scalar, const vec_impl<T, len>& other) {
...
template<typename T, unsigned len>
constexpr inline vec_impl<T, len> operator -(const vec_impl<T, len>& other) {
    vec_impl<T, len> result;
    for_range<0, len>([&]<auto i>(){
...
template<typename T, unsigned len>
static inline auto dot(const vec_impl<T, len>& vec, const vec_impl<T, len>& other) {
    return vec.dot(other);
}

template<typename T, unsigned len>
static inline auto cross(const vec_impl<T, len>& vec, const vec_impl<T, len>& other) {
...
# 20 "C:/Users/darkg/HAG/shady/include/nasl/nasl.h" 2 3 4
# 7 "C:/Users/darkg/HAG/sigcraft/camera.h" 2
# 1 "C:/Users/darkg/HAG/shady/include/nasl/nasl_mat.h" 1 3 4
...
static inline vec4 mul_mat4_vec4(mat4 l, vec4 r);
...
union mat4_ {
    ...
    constexpr inline mat4 operator*(const mat4& other) {
        return mul_mat4(*this, other);
    }

    constexpr inline vec4 operator*(const vec4& other) {
...
static inline mat4 mul_mat4(mat4 l, mat4 r) {
    ...
    dst.elems.m00 = l.elems.m00 * r.elems.m00 + l.elems.m10 * r.elems.m01 + l.elems.m20 * r.elems.m02 + l.elems.m30 * r.elems.m03; dst.elems.m01 = l.elems.m01 * r.elems.m00 + l.elems.m11 * r.elems.m01 + l.elems.m21 * r.elems.m02 + l.elems.m31 * r.elems.m03; dst.elems.m02 = l.elems.m02 * r.elems.m00 + l.elems.m12 * r.elems.m01 + l.elems.m22 * r.elems.m02 + l.elems.m32 * r.elems.m03; dst.elems.m03 = l.elems.m03 * r.elems.m00 + l.elems.m13 * r.elems.m01 + l.elems.m23 * r.elems.m02 + l.elems.m33 * r.elems.m03; dst.elems.m10 = l.elems.m00 * r.elems.m10 + l.elems.m10 * r.elems.m11 + l.elems.m20 * r.elems.m12 + l.elems.m30 * r.elems.m13; dst.elems.m11 = l.elems.m01 * r.elems.m10 + l.elems.m11 * r.elems.m11 + l.elems.m21 * r.elems.m12 + l.elems.m31 * r.elems.m13; dst.elems.m12 = l.elems.m02 * r.elems.m10 + l.elems.m12 * r.elems.m11 + l.elems.m22 * r.elems.m12 + l.elems.m32 * r.elems.m13; dst.elems.m13 = l.elems.m03 * r.elems.m10 + l.elems.m13 * r.elems.m11 + l.elems.m23 * r.elems.m12 + l.elems.m33 * r.elems.m13; dst.elems.m20 = l.elems.m00 * r.elems.m20 + l.elems.m10 * r.elems.m21 + l.elems.m20 * r.elems.m22 + l.elems.m30 * r.elems.m23; dst.elems.m21 = l.elems.m01 * r.elems.m20 + l.elems.m11 * r.elems.m21 + l.elems.m21 * r.elems.m22 + l.elems.m31 * r.elems.m23; dst.elems.m22 = l.elems.m02 * r.elems.m20 + l.elems.m12 * r.elems.m21 + l.elems.m22 * r.elems.m22 + l.elems.m32 * r.elems.m23; dst.elems.m23 = l.elems.m03 * r.elems.m20 + l.elems.m13 * r.elems.m21 + l.elems.m23 * r.elems.m22 + l.elems.m33 * r.elems.m23; dst.elems.m30 = l.elems.m00 * r.elems.m30 + l.elems.m10 * r.elems.m31 + l.elems.m20 * r.elems.m32 + l.elems.m30 * r.elems.m33; dst.elems.m31 = l.elems.m01 * r.elems.m30 + l.elems.m11 * r.elems.m31 + l.elems.m21 * r.elems.m32 + l.elems.m31 * r.elems.m33; dst.elems.m32 = l.elems.m02 * r.elems.m30 + l.elems.m12 * r.elems.m31 + l.elems.m22 * r.elems.m32 + l.elems.m32 * r.elems.m33; dst.elems.m33 = l.elems.m03 * r.elems.m30 + l.elems.m13 * r.elems.m31 + l.elems.m23 * r.elems.m32 + l.elems.m33 * r.elems.m33;
    return dst;
...
static inline vec4 mul_mat4_vec4(mat4 l, vec4 r) {
    ...
    dst[0] = l.elems.m00 * src[0] + l.elems.m10 * src[1] + l.elems.m20 * src[2] + l.elems.m30 * src[3]; dst[1] = l.elems.m01 * src[0] + l.elems.m11 * src[1] + l.elems.m21 * src[2] + l.elems.m31 * src[3]; dst[2] = l.elems.m02 * src[0] + l.elems.m12 * src[1] + l.elems.m22 * src[2] + l.elems.m32 * src[3]; dst[3] = l.elems.m03 * src[0] + l.elems.m13 * src[1] + l.elems.m23 * src[2] + l.elems.m33 * src[3];
...
static inline mat3 transpose_mat3(mat3 src) {
    mat3 m = {
...
static inline mat3 mul_mat3(mat3 l, mat3 r) {
    mat3 dst = { 0 };
    ...
    dst.elems.m00 = l.elems.m00 * r.elems.m00 + l.elems.m10 * r.elems.m01 + l.elems.m20 * r.elems.m02; dst.elems.m01 = l.elems.m01 * r.elems.m00 + l.elems.m11 * r.elems.m01 + l.elems.m21 * r.elems.m02; dst.elems.m02 = l.elems.m02 * r.elems.m00 + l.elems.m12 * r.elems.m01 + l.elems.m22 * r.elems.m02; dst.elems.m10 = l.elems.m00 * r.elems.m10 + l.elems.m10 * r.elems.m11 + l.elems.m20 * r.elems.m12; dst.elems.m11 = l.elems.m01 * r.elems.m10 + l.elems.m11 * r.elems.m11 + l.elems.m21 * r.elems.m12; dst.elems.m12 = l.elems.m02 * r.elems.m10 + l.elems.m12 * r.elems.m11 + l.elems.m22 * r.elems.m12; dst.elems.m20 = l.elems.m00 * r.elems.m20 + l.elems.m10 * r.elems.m21 + l.elems.m20 * r.elems.m22; dst.elems.m21 = l.elems.m01 * r.elems.m20 + l.elems.m11 * r.elems.m21 + l.elems.m21 * r.elems.m22; dst.elems.m22 = l.elems.m02 * r.elems.m20 + l.elems.m12 * r.elems.m21 + l.elems.m22 * r.elems.m22;
    return dst;
...
# 8 "C:/Users/darkg/HAG/sigcraft/camera.h" 2


# 9 "C:/Users/darkg/HAG/sigcraft/camera.h"
...
# 4 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 2
...
__attribute__((dllimport)) GLFWerrorfun glfwSetErrorCallback(GLFWerrorfun callback);
...
__attribute__((dllimport)) void glfwGetMonitorPos(GLFWmonitor* monitor, int* xpos, int* ypos);
# 2657 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetMonitorWorkarea(GLFWmonitor* monitor, int* xpos, int* ypos, int* width, int* height);
# 2692 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetMonitorPhysicalSize(GLFWmonitor* monitor, int* widthMM, int* heightMM);
# 2727 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetMonitorContentScale(GLFWmonitor* monitor, float* xscale, float* yscale);
...
__attribute__((dllimport)) void glfwSetMonitorUserPointer(GLFWmonitor* monitor, void* pointer);
...
__attribute__((dllimport)) GLFWmonitorfun glfwSetMonitorCallback(GLFWmonitorfun callback);
# 2867 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) const GLFWvidmode* glfwGetVideoModes(GLFWmonitor* monitor, int* count);
# 2895 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) const GLFWvidmode* glfwGetVideoMode(GLFWmonitor* monitor);
...
__attribute__((dllimport)) const GLFWgammaramp* glfwGetGammaRamp(GLFWmonitor* monitor);
# 2999 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetGammaRamp(GLFWmonitor* monitor, const GLFWgammaramp* ramp);
...
__attribute__((dllimport)) GLFWwindow* glfwCreateWindow(int width, int height, const char* title, GLFWmonitor* monitor, GLFWwindow* share);
...
__attribute__((dllimport)) void glfwSetWindowShouldClose(GLFWwindow* window, int value);
...
__attribute__((dllimport)) void glfwSetWindowTitle(GLFWwindow* window, const char* title);
# 3413 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowIcon(GLFWwindow* window, int count, const GLFWimage* images);
# 3445 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetWindowPos(GLFWwindow* window, int* xpos, int* ypos);
# 3480 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowPos(GLFWwindow* window, int xpos, int ypos);
# 3510 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetWindowSize(GLFWwindow* window, int* width, int* height);
# 3553 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowSizeLimits(GLFWwindow* window, int minwidth, int minheight, int maxwidth, int maxheight);
# 3596 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowAspectRatio(GLFWwindow* window, int numer, int denom);
# 3634 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowSize(GLFWwindow* window, int width, int height);
# 3663 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetFramebufferSize(GLFWwindow* window, int* width, int* height);
# 3700 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetWindowFrameSize(GLFWwindow* window, int* left, int* top, int* right, int* bottom);
# 3733 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwGetWindowContentScale(GLFWwindow* window, float* xscale, float* yscale);
...
__attribute__((dllimport)) void glfwSetWindowOpacity(GLFWwindow* window, float opacity);
...
__attribute__((dllimport)) void glfwSetWindowMonitor(GLFWwindow* window, GLFWmonitor* monitor, int xpos, int ypos, int width, int height, int refreshRate);
...
__attribute__((dllimport)) void glfwSetWindowAttrib(GLFWwindow* window, int attrib, int value);
# 4176 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetWindowUserPointer(GLFWwindow* window, void* pointer);
...
__attribute__((dllimport)) GLFWwindowposfun glfwSetWindowPosCallback(GLFWwindow* window, GLFWwindowposfun callback);
# 4264 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowsizefun glfwSetWindowSizeCallback(GLFWwindow* window, GLFWwindowsizefun callback);
# 4304 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowclosefun glfwSetWindowCloseCallback(GLFWwindow* window, GLFWwindowclosefun callback);
# 4340 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowrefreshfun glfwSetWindowRefreshCallback(GLFWwindow* window, GLFWwindowrefreshfun callback);
# 4375 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowfocusfun glfwSetWindowFocusCallback(GLFWwindow* window, GLFWwindowfocusfun callback);
# 4405 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowiconifyfun glfwSetWindowIconifyCallback(GLFWwindow* window, GLFWwindowiconifyfun callback);
# 4435 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowmaximizefun glfwSetWindowMaximizeCallback(GLFWwindow* window, GLFWwindowmaximizefun callback);
# 4465 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWframebuffersizefun glfwSetFramebufferSizeCallback(GLFWwindow* window, GLFWframebuffersizefun callback);
# 4496 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWwindowcontentscalefun glfwSetWindowContentScaleCallback(GLFWwindow* window, GLFWwindowcontentscalefun callback);
...
__attribute__((dllimport)) void glfwSetInputMode(GLFWwindow* window, int mode, int value);
...
__attribute__((dllimport)) void glfwGetCursorPos(GLFWwindow* window, double* xpos, double* ypos);
# 5008 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetCursorPos(GLFWwindow* window, double xpos, double ypos);
# 5046 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWcursor* glfwCreateCursor(const GLFWimage* image, int xhot, int yhot);
...
__attribute__((dllimport)) void glfwSetCursor(GLFWwindow* window, GLFWcursor* cursor);
# 5198 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWkeyfun glfwSetKeyCallback(GLFWwindow* window, GLFWkeyfun callback);
# 5241 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWcharfun glfwSetCharCallback(GLFWwindow* window, GLFWcharfun callback);
# 5283 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWcharmodsfun glfwSetCharModsCallback(GLFWwindow* window, GLFWcharmodsfun callback);
# 5320 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWmousebuttonfun glfwSetMouseButtonCallback(GLFWwindow* window, GLFWmousebuttonfun callback);
# 5352 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWcursorposfun glfwSetCursorPosCallback(GLFWwindow* window, GLFWcursorposfun callback);
# 5383 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWcursorenterfun glfwSetCursorEnterCallback(GLFWwindow* window, GLFWcursorenterfun callback);
# 5417 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWscrollfun glfwSetScrollCallback(GLFWwindow* window, GLFWscrollfun callback);
# 5452 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) GLFWdropfun glfwSetDropCallback(GLFWwindow* window, GLFWdropfun callback);
...
__attribute__((dllimport)) const unsigned char* glfwGetJoystickButtons(int jid, int* count);
# 5607 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) const unsigned char* glfwGetJoystickHats(int jid, int* count);
...
__attribute__((dllimport)) GLFWjoystickfun glfwSetJoystickCallback(GLFWjoystickfun callback);
...
__attribute__((dllimport)) int glfwGetGamepadState(int jid, GLFWgamepadstate* state);
# 5927 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
__attribute__((dllimport)) void glfwSetClipboardString(GLFWwindow* window, const char* string);
...
__attribute__((dllimport)) const char** glfwGetRequiredInstanceExtensions(uint32_t* count);
# 6543 "C:/msys64/mingw64/include/GLFW/glfw3.h" 3
}
# 5 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 2


# 6 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
using namespace nasl;
...
void camera_update(GLFWwindow* handle, CameraInput* input) {
    input->mouse_held = glfwGetMouseButton(handle, 
# 59 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                  0
# 59 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                        ) == 
# 59 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                                             1
# 59 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
    ...
    input->keys.forward = glfwGetKey(handle, 
# 61 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                            87
# 61 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                      ) == 
# 61 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                           1
# 61 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                     ;
    input->keys.back = glfwGetKey(handle, 
# 62 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                         83
# 62 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                   ) == 
# 62 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                        1
# 62 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                  ;
    input->keys.left = glfwGetKey(handle, 
# 63 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                         65
# 63 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                   ) == 
# 63 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                        1
# 63 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                  ;
    input->keys.right = glfwGetKey(handle, 
# 64 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                          68
# 64 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                    ) == 
# 64 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                         1
# 64 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
...
# 66 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                0x00033001
# 66 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                           , 
# 66 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                             0x00034003
# 66 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
        ...
        glfwSetInputMode(handle, 
# 68 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                0x00033001
# 68 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                           , 
# 68 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                             0x00034001
# 68 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
...
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
   (void) ((!!(
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
   cam && input && state
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
   )) || (_assert(
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
   "cam && input && state"
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
   ,"C:/Users/darkg/HAG/sigcraft/camera.cpp",72),0))
# 72 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                ;
    bool moved = false;
    if (input->mouse_held) {
        if (state->mouse_was_held) {
            ...
            cam->rotation.yaw += (float) diff_x / (180.0f * (float) 
# 78 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                                     3.14159265358979323846
# 78 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                         ) * state->mouse_sensitivity;
            cam->rotation.pitch += (float) diff_y / (180.0f * (float) 
# 79 "C:/Users/darkg/HAG/sigcraft/camera.cpp" 3
                                                                     3.14159265358979323846
# 79 "C:/Users/darkg/HAG/sigcraft/camera.cpp"
                                                                         ) * state->mouse_sensitivity;
            moved = true;
        } else
